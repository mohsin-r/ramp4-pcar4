import { Q as x, a4 as Q, b7 as E, b8 as A, b9 as K, bh as I, a0 as M, eJ as W, eN as U, eO as j } from "./main-DHMhSwB4.js";
import { a as k, b as u, r as f, x as B, d as G, G as w, a9 as C, v as V, N as T, U as b, q as O, E as P, X as q, k as X, t as Y, aa as z, ab as D, ac as H } from "./arcadeUtils-B9B6DlKX.js";
import { l as L } from "./portalUtils-BMyPv0tI.js";
import { p as Z, n as _ } from "./project-B8a8P2S8.js";
import { a as $, m as nn, t as tn, p as en, c as an } from "./GraphQueryStreaming-B4tpGlD4.js";
let c = null;
async function rn(n) {
...
async function N(n, t) {
  ...
  return await a.load(), c === null && (c = await import("./knowledgeGraphService-CsQ9XhJH.js").then((i) => i.k)), await c.fetchKnowledgeGraph(a.url);
}
...
function pn(n) {
  n.mode === "async" && (n.functions.knowledgegraphbyportalitem = function(t, a) {
    ...
    return n.standardFunctionAsync(t, a, async (i, s, e) => {
      ...
      c === null && (c = await import("./knowledgeGraphService-CsQ9XhJH.js").then((o) => o.k));
      let p = null;
      const m = V(e[2], null);
...
//# sourceMappingURL=knowledgegraph-CD_Qual4.js.map
