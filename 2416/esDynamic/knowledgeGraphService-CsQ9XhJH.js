import { N as i, O as s, P as w, dU as Y, b_ as O, bh as L, af as Fe, hX as le, s as d, eJ as ee, aT as fe, a6 as ge, aS as te, aR as re, C as _e, a2 as k, a3 as De } from "./main-DHMhSwB4.js";
import { m as me, p as we, t as Ne, c as ze } from "./GraphQueryStreaming-B4tpGlD4.js";
...
async function Le(e) {
  if (e) {
    const { default: t } = await import("./arcgis-knowledge-client-core-simd-D5mTEwn8.js").then((n) => n.a);
    return t({ locateFile: (n) => le(ue + n) });
  }
  const { default: r } = await import("./arcgis-knowledge-client-core-GelmerL2.js").then((t) => t.a);
...
//# sourceMappingURL=knowledgeGraphService-CsQ9XhJH.js.map
