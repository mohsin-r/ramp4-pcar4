import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-DHMhSwB4.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-CluBVUOX.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-BDkbBaU4.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-qy-WDYVc.js")).default, n = (await import("./index-H6fvavMY.js")).default, a = (await import("./index-3X80WXDS.js")).default, w = (await import("./index-DVFmF-f3.js")).default, p = (await import("./index-BB493sNn.js")).default, r = (await import("./index-CRQkMrpb.js")).default, b = (await import("./index-CIZrNge_.js")).default;
...
//# sourceMappingURL=index-DH1beLp4.js.map
