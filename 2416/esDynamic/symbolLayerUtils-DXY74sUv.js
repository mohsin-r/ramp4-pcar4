import { dK as d, s as n, dL as a, bl as m, dM as v, ci as c } from "./main-DHMhSwB4.js";
let u = h();
function h() {
  return new d(50);
}
async function p(r, o = null) {
  if (!r.isPrimitive) {
    ...
    const { fetch: l } = await import("./objectResourceUtils-M7I5bRBE.js"), f = await l(e, { disableTextures: !0 }), s = a(f.referenceBoundingBox, c());
    return u.put(e, s), s;
  }
...
//# sourceMappingURL=symbolLayerUtils-DXY74sUv.js.map
