import { am as m, au as d, a2 as u, K as w, s as p } from "./main-DHMhSwB4.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-Bfb2rHHk.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-Cht8C2SL.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-r8vtzPgk.js.map
