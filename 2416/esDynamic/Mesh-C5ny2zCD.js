import { bb as Et, eA as kt, nz as Ut, ci as S, N as c, O as f, f_ as Wt, et as zt, d$ as Ht, P as U, b_ as ce, ec as Pe, b$ as Se, dS as Vt, ax as Ke, jc as W, C as T, ag as L, s as ie, hs as Bt, hV as _, ba as Gt, kO as Yt, fr as me, nA as $e, nB as Xt, bl as Zt, nC as qt, aU as et, cr as tt, cu as Jt, gP as rt, a8 as Le, a6 as P, R as Qt, nD as Kt, mn as er, jH as tr, lJ as rr, jb as nr, V as or, b2 as sr, fs as je, ch as ir, iV as ar, ez as nt, nE as ot, lT as lr, hD as we, j4 as st, nF as it, j1 as at, nG as lt, nH as ct, iX as cr, hU as ur, ct as pr, eV as hr, jP as fr, U as mr, cj as be, aR as gr, nI as dr, eJ as yr } from "./main-DHMhSwB4.js";
import { G as xr, c as _e, Q as wr, I as vr, V as $r, _ as br, b as ut, d as ae, A as pt, y as ge, k as ht, a as ft, j as mt, h as gt, E as dt, e as yt, f as xt, w as Tr } from "./georeference-fg7RC-kN.js";
import { c as Ar } from "./imageUtils-r8vtzPgk.js";
import { i as Re, a as Sr } from "./MeshLocalVertexSpace-B-y6x13x.js";
import { g as de, p as wt, u as Ee, h as ke, l as Ue } from "./meshVertexSpaceUtils-JWx2COph.js";
import { i as jr } from "./earcut-CTci0Xld.js";
import { a as Rr, e as Mr, t as vt } from "./DoubleArray-C0fItC4t.js";
import { t as $t } from "./Indices-CjUdz_tx.js";
import { e as We } from "./deduplicate-OxOm0UUv.js";
import { E as Fr, F as Ir, X as Lr } from "./plane-DxttzBvs.js";
import "./triangle-B0CU223h.js";
import { e as ve } from "./mat4f64-Dn1WEGBx.js";
import "./basicInterfaces-DTnusSyV.js";
import "./VertexAttribute-CAkzp1tV.js";
import { u as ze, y as _r, h as Cr } from "./External-BmIQjA3x.js";
import { e as bt } from "./mat3f64-Dh9_zhFu.js";
import { I as Dr } from "./quat-DWpYM0f-.js";
import { e as Nr, o as Or } from "./quatf64-DxbQqBtW.js";
import { a as Ce, R as Tt } from "./computeTranslationToOriginAndRotation-T_JQiLvx.js";
function F(e, t, n, r) {
...
async function rn(e, t, n) {
  const { source: r } = t, { loadGLTFMesh: o } = await rt(import("./loadGLTFMesh-BD-tCeDs.js"), n), s = await on(r, n);
  Le(n);
...
let $ = M = class extends hr.LoadableMixin(fr(yr)) {
  ...
  async toBinaryGLTF(e) {
    const t = import("./gltfexport-Cgmdio28.js"), n = this.load(), r = await Promise.all([t, n]), { toBinaryGLTF: o } = r[0];
    return o(this, e);
  }
  get memoryUsage() {
    let e = 0;
  ...
  static async createFromGLTF(e, t, n) {
    ...
    const { loadGLTFMesh: r } = await rt(import("./loadGLTFMesh-BD-tCeDs.js"), n);
...
//# sourceMappingURL=Mesh-C5ny2zCD.js.map
