import { bC as E, bD as L, bE as x, bF as C, bG as I, bH as A, bI as B, bJ as D, bK as i, bL as l, bM as p, bN as n, bO as w, bP as N, bQ as s, bR as T, bS as V, bT as u, bU as j, bV as F, bW as d } from "./main-DHMhSwB4.js";
const H = ["content"], O = /* @__PURE__ */ E({
  ...
  setup(b) {
    const v = d(() => import("./header-ucFjPUre.js")), m = d(() => import("./item-BrRtJ2_2.js")), { t: r } = L(), _ = x("iApi"), e = C(), a = () => {
      e.value._tippy.hide();
    }, o = (t) => {
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-C1Vxwlti.js.map
