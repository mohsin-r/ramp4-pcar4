import { af as le, hX as ue } from "./main-DHMhSwB4.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-BtknMI_w.js").then((i) => i.l) : await import("./libtess-CbLOgH5p.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-B_E2tyoC.js.map
