import { hX as K, bh as D } from "./main-DHMhSwB4.js";
import { y as X } from "./DoubleArray-C0fItC4t.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-B-y6x13x.js";
import { n as Z, s as ee } from "./vec3-COTaczhZ.js";
import "./sphere-CattsawI.js";
import "./I3SUtil-BUmCoTV7.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-kjZnHKMi.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DHMhSwB4.js").then((d) => d.qK), import("./main-DHMhSwB4.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-fg7RC-kN.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-TTyk85sV.js.map
