import { hX as T } from "./main-DHMhSwB4.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-B5scaoYb.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-Ga8--9zF.js.map
