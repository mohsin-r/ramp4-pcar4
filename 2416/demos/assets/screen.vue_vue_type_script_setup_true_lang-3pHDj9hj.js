const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./header-Bag4YC1A.js","./main-DoZrzYXH.js","./preload-helper-dJJaZANz.js","./main-C4TGYCrz.css","./header-C5SUlT6S.css","./item-CJA2OtGy.js","./marked.esm-DcwJ8j7Z.js","./item-CK0LdWFG.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bF as defineComponent, bG as useI18n, bH as inject, bI as ref, bJ as onMounted, bK as onBeforeUnmount, bL as computed, bM as resolveComponent, bN as resolveDirective, bO as createBlock, bP as withCtx, bQ as openBlock, bR as createTextVNode, bS as toDisplayString, bT as unref, bU as createVNode, bV as withDirectives, bW as createElementBlock, bX as Fragment, bY as renderList, bZ as defineAsyncComponent } from './main-DoZrzYXH.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const legendHeader = defineAsyncComponent(() => __vitePreload(() => import('./header-Bag4YC1A.js'),true?__vite__mapDeps([0,1,2,3,4]):void 0,import.meta.url));
    const legendItem = defineAsyncComponent(() => __vitePreload(() => import('./item-CJA2OtGy.js'),true?__vite__mapDeps([5,1,2,3,6,7]):void 0,import.meta.url));
    const { t } = useI18n();
