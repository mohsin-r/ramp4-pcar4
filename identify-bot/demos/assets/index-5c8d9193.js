...
import { bG as defineComponent, bI as inject, bN as resolveComponent, bP as openBlock, bQ as createBlock, bR as withCtx, fH as createBaseVNode, iM as normalizeStyle, bS as createTextVNode, bH as useI18n, bT as toDisplayString, bU as unref, bB as FixtureInstance, he as markRaw } from './main-fb35569c.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-69e3a71a.js'),true?["./p2-screen-1-69e3a71a.js","./main-fb35569c.js","./preload-helper-a4975f27.js","./main-7e7f41a5.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
