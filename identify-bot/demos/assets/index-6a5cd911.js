...
const _hoisted_11$1 = ["content", "aria-label"];
const _hoisted_12$1 = {
  key: 0,
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$2, [
          supportsFeatures.value ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
            ...
            ]) : (openBlock(), createElementBlock("div", _hoisted_9$1, toDisplayString(unref(t)("details.loading")), 1)),
            __props.data.loaded ? (openBlock(), createElementBlock("span", _hoisted_10$1, [
              isMapLayer.value ? withDirectives((openBlock(), createElementBlock("button", {
                ...
                zoomStatus.value === "zooming" ? (openBlock(), createElementBlock("div", _hoisted_12$1)) : zoomStatus.value === "zoomed" ? (openBlock(), createElementBlock("svg", _hoisted_13$1, _hoisted_15$1)) : zoomStatus.value === "error" ? (openBlock(), createElementBlock("svg", _hoisted_16$1, _hoisted_18$1)) : (openBlock(), createElementBlock("span", {
                  key: 3,
...
const _withScopeId = (n) => (pushScopeId("data-v-31394f48"), n = n(), popScopeId(), n);
const _hoisted_1$1 = {
  key: 0,
...
const _hoisted_10 = { class: "px-3 text-center flex-grow" };
const _hoisted_11 = ["content", "aria-label", "disabled"];
const _hoisted_12 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
  height: "24",
  width: "24",
  viewBox: "0 0 23 23"
}, [
...
const _hoisted_20 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "animate-spin spinner h-20 w-20 px-5 mr-8" }, null, -1));
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return isLayerResultLoaded.value && activeGreedy.value === 0 ? (openBlock(), createElementBlock("div", {
        ...
        showPaginator.value ? (openBlock(), createElementBlock("div", _hoisted_4, [
          createBaseVNode("div", _hoisted_5, [
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("span", _hoisted_10, toDisplayString(showList.value ? unref(t)("details.items.range", [
                currentIdx.value + 1,
                Math.min(
                  endIdx.value,
        ...
        layerExists.value ? (openBlock(), createElementBlock("div", _hoisted_14, [
          getLayerIdentifyItems().length > 0 ? (openBlock(), createElementBlock("div", _hoisted_15, [
            showList.value ? withDirectives((openBlock(), createElementBlock("div", _hoisted_16, [
          ...
          ])) : (openBlock(), createElementBlock("div", _hoisted_18, toDisplayString(unref(t)("details.layers.results.empty.currentLayer")), 1))
        ])) : (openBlock(), createElementBlock("div", _hoisted_19, toDisplayString(unref(t)("details.item.no.data")), 1))
...
const resultList_vue_vue_type_style_index_0_scoped_31394f48_lang = '';

const ResultList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-31394f48"]]);
