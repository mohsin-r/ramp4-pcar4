...
import { m as m$a, a as u$b, e as e$n, c as a$h } from './Texture-BEoxsVE3.js';
import { H as H$4 } from './InterleavedLayout-Bfb-WAME.js';
...
import { w as w$1, Z as Z$2 } from './sphere-BpHDMTzV.js';
import { a as a$f } from './BindType-KnpK3yZX.js';
import { n as n$c } from './symbolColorUtils-DyFFeZsx.js';
...
function t$i(){if(null==s$b){const t=t=>n$9(`esri/libs/basisu/${t}`);s$b=__vitePreload(() => import('./basis_transcoder-P0fRleSA.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((e=>e.b)).then((({default:e})=>e({locateFile:t}).then((e=>(e.initializeBasis(),delete e.then,e)))));}return s$b}let s$b;
