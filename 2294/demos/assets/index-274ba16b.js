...
import { bG as defineComponent, bI as inject, bN as resolveComponent, bP as openBlock, bQ as createBlock, bR as withCtx, fH as createBaseVNode, iM as normalizeStyle, bS as createTextVNode, bH as useI18n, bT as toDisplayString, bU as unref, bB as FixtureInstance, he as markRaw } from './main-d7ab64e3.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-4c81f0e7.js'),true?["./p2-screen-1-4c81f0e7.js","./main-d7ab64e3.js","./preload-helper-a4975f27.js","./main-d4591045.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
