const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./fabric-BPC72u-O.js","./main-94WFCC9C.js","./preload-helper-dJJaZANz.js","./main-CY4W0263.css","./index-BJRyhDh5.js","./index-BukldW2r.js","./index-DnYWd4TW.js","./index-DsrrenHk.js","./index-kulAiboK.js","./index-DZsu58P7.js","./index-wpX_2K4g.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { iS as commonjsGlobal, iT as getDefaultExportFromCjs, bA as FixtureInstance, fF as useExportStore, he as markRaw, fO as GlobalEvents, hf as useAppbarStore } from './main-94WFCC9C.js';
import { _ as _sfc_main } from './screen.vue_vue_type_script_setup_true_lang-hlUwcKT3.js';
...
class ExportAPI extends FixtureInstance {
  ...
  async make(canvas, panelWidth) {
    const { fabric } = await __vitePreload(async () => { const { fabric } = await import('./fabric-BPC72u-O.js').then(n => n.f);return { fabric }},true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url);
...
class ExportFixture extends ExportAPI {
  ...
  async needed() {
    const exportTitle = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-BJRyhDh5.js');return { default: __vite_default__ }},true?__vite__mapDeps([4,0,1,2,3]):void 0,import.meta.url)).default;
    const exportMap = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-BukldW2r.js');return { default: __vite_default__ }},true?__vite__mapDeps([5,0,1,2,3]):void 0,import.meta.url)).default;
    const exportLegend = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-DnYWd4TW.js');return { default: __vite_default__ }},true?__vite__mapDeps([6,1,2,3,0]):void 0,import.meta.url)).default;
    const exportNorthArrow = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-DsrrenHk.js');return { default: __vite_default__ }},true?__vite__mapDeps([7,0,1,2,3]):void 0,import.meta.url)).default;
    const exportScalebar = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-kulAiboK.js');return { default: __vite_default__ }},true?__vite__mapDeps([8,0,1,2,3]):void 0,import.meta.url)).default;
    const exportTimestamp = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-DZsu58P7.js');return { default: __vite_default__ }},true?__vite__mapDeps([9,0,1,2,3]):void 0,import.meta.url)).default;
    const exportFootnote = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./index-wpX_2K4g.js');return { default: __vite_default__ }},true?__vite__mapDeps([10,0,1,2,3]):void 0,import.meta.url)).default;
