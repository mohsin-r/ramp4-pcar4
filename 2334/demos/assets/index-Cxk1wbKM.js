const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./p2-screen-1-NVbl_PLP.js","./main-94WFCC9C.js","./preload-helper-dJJaZANz.js","./main-CY4W0263.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bF as defineComponent, bH as inject, bM as resolveComponent, bO as createBlock, bP as withCtx, bQ as openBlock, fG as createBaseVNode, iK as normalizeStyle, bR as createTextVNode, bG as useI18n, bS as toDisplayString, bT as unref, bA as FixtureInstance, he as markRaw } from './main-94WFCC9C.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-NVbl_PLP.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((data) => {
                    resolve(data);
                  }),
                  2e3
                )
