import { bC as E, bD as L, bE as x, bF as C, bG as I, bH as A, bI as B, bJ as D, bK as i, bL as l, bM as p, bN as n, bO as w, bP as N, bQ as s, bR as T, bS as V, bT as u, bU as j, bV as F, bW as d } from "./main-BL24Y93j.js";
const H = ["content"], O = /* @__PURE__ */ E({
  ...
  setup(b) {
    const v = d(() => import("./header-BNdN8Ka5.js")), m = d(() => import("./item-1brTPnaM.js")), { t: r } = L(), _ = x("iApi"), e = C(), a = () => {
      e.value._tippy.hide();
    }, o = (t) => {
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-D7Rl_Byw.js.map
