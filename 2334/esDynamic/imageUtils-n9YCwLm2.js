import { am as m, au as d, a2 as u, K as w, s as p } from "./main-BL24Y93j.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-Co4kGuDA.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-CBUCMFqL.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-n9YCwLm2.js.map
