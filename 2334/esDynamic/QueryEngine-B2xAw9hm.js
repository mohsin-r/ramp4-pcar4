import { n as ct, a as Z, h as H, j as V, y as re, P as We, x as ye, g as U, b as ht, c as dt, S as Fe, v as B, t as mt, I as Se, d as ft } from "./timeSupport-DeCJ0VsB.js";
import { d6 as gt, d7 as pt, dK as Re, s as A, cX as be, aW as de, aX as me, cN as Xe, cO as Je, dc as fe, J as k, aV as we, da as ne, lF as Ae, lG as _t, ky as Ce, k1 as yt, lH as Tt, ag as ee, lI as ge, jH as Ke, lJ as te, eM as Et, N as le, O as ve, P as xt, dU as It, lK as oe, bt as ue, U as Ft, X as St, lL as pe, aM as O, C as Rt, lM as bt, T as wt, lN as At, lO as Ct, lP as vt, aB as Nt, cW as Ot, b5 as Pt, lQ as v, ao as Ne, eK as Oe, a8 as $t, lR as kt, bl as Dt, bo as Lt, ba as ce, bu as Qt, bi as Vt, c$ as Gt, av as Mt, lS as Pe, aF as Ut, aH as qt, az as zt, bm as Bt, bw as jt } from "./main-BL24Y93j.js";
import { x as Zt } from "./WhereClause-DuK03P4S.js";
import { t as Ht } from "./QueryEngineCapabilities-Deb54eFC.js";
import { w as Yt } from "./utils-3coCKQz3.js";
import { c as he, B as Wt, d as $e, p as ke, C as Xt, k as Jt, $ as Kt, E as es, P as ts, U as ss, T as is, v as as, f as rs } from "./utils-DFC-ir9l.js";
...
class w {
  ...
  async _getAggregateGeometry(e, t) {
    const { convexHull: i, union: a } = await import("./geometryEngineJSON-ChnZ_cq6.js").then((d) => d.g), { statisticType: s, outStatisticFieldName: r } = e, { featureAdapter: n, spatialReference: o, geometryType: u, hasZ: c, hasM: h } = this, m = t.map((d) => Z(u, c, h, n.getGeometry(d))), f = i(o, m, !0)[0], p = { aggregateGeometries: null, outStatisticFieldName: null };
...
//# sourceMappingURL=QueryEngine-B2xAw9hm.js.map
