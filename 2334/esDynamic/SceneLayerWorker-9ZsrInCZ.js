import { hX as K, bh as D } from "./main-BL24Y93j.js";
import { y as X } from "./DoubleArray-auUzu8Vb.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-DAiKHQ5Y.js";
import { n as Z, s as ee } from "./vec3-DSkC_0i7.js";
import "./sphere-D7btbxTO.js";
import "./I3SUtil-Nh33XORq.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-xSWwGduL.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BL24Y93j.js").then((d) => d.qK), import("./main-BL24Y93j.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DbJAMp7a.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-9ZsrInCZ.js.map
