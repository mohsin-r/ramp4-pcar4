import { Q as x, a4 as Q, b7 as E, b8 as A, b9 as K, bh as I, a0 as M, eJ as W, eN as U, eO as j } from "./main-BL24Y93j.js";
import { a as k, b as u, r as f, x as B, d as G, G as w, a9 as C, v as V, N as T, U as b, q as O, E as P, X as q, k as X, t as Y, aa as z, ab as D, ac as H } from "./arcadeUtils-CS_fKkLn.js";
import { l as L } from "./portalUtils-DKjVQBpd.js";
import { p as Z, n as _ } from "./project-CuG5eME_.js";
import { a as $, m as nn, t as tn, p as en, c as an } from "./GraphQueryStreaming-BUlNPXR-.js";
let c = null;
async function rn(n) {
...
async function N(n, t) {
  ...
  return await a.load(), c === null && (c = await import("./knowledgeGraphService-D7NVBv9q.js").then((i) => i.k)), await c.fetchKnowledgeGraph(a.url);
}
...
function pn(n) {
  n.mode === "async" && (n.functions.knowledgegraphbyportalitem = function(t, a) {
    ...
    return n.standardFunctionAsync(t, a, async (i, s, e) => {
      ...
      c === null && (c = await import("./knowledgeGraphService-D7NVBv9q.js").then((o) => o.k));
      let p = null;
      const m = V(e[2], null);
...
//# sourceMappingURL=knowledgegraph-oArmp0An.js.map
