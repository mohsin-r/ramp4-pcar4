...
let j = class extends J {
  ...
  loadDependencies() {
    return De({ icon: () => import("./calcite-icon-DlvEO2Xc.js") });
  }
  get capabilities() {
...
async function hr(t, e, i) {
  ...
  const c = s ? null : ur(n);
  return (await Promise.all(n.map(async (h, p) => ({ value: h, color: t.type === "opacity" ? await pr(h, t) : (await import("./main-BL24Y93j.js").then((m) => m.qJ)).getColor(t, h), label: s ? r[p] : c?.[p] ?? "" })))).reverse();
}
async function pr(t, e, i) {
  const s = new zi(cr), n = (await import("./main-BL24Y93j.js").then((r) => r.qJ)).getOpacity(e, t);
...
let Z = class extends J {
  constructor(e, i) {
    super(e, i), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new Fe(), this.messages = null, this._disposeChart = (s) => {
      ...
      if (n || !r || !s) return;
      const { createRoot: l } = await import("./chartUtilsAm5-C78da6qT.js"), d = await l(s);
  ...
  async _getSeriesColors(e) {
    const { colorAm5: i } = await import("./chartCommon-4BweAu9u.js"), s = /* @__PURE__ */ new Map();
    return e.forEach((n) => {
      n.color && s.set(n, i(n.color.toCss(!0)));
    }), s;
  }
  async _getRendererColors() {
    const { colorAm5: e } = await import("./chartCommon-4BweAu9u.js"), i = /* @__PURE__ */ new Map(), s = this._getRenderer(), n = "default";
    if (!s) return i;
    const r = await fr(s);
  ...
  async _renderChart(e) {
    const { root: i, mediaInfo: s } = e, { value: n, type: r } = s, { ResponsiveThemeAm5: l, DarkThemeAm5: d, AnimatedThemeAm5: c, ColorSetAm5: h, ThemeAm5: p, esriChartColorSet: m } = await import("./chartCommon-4BweAu9u.js"), f = p.new(i);
  ...
  async _customizeChartTooltip(e, i = "horizontal") {
    const { colorAm5: s } = await import("./chartCommon-4BweAu9u.js");
  ...
  async _createPieChart(e, i) {
    const { TooltipAm5: s } = await import("./chartCommon-4BweAu9u.js"), { PieChartAm5: n, PieSeriesAm5: r } = await import("./pieChart-BBpkWHNO.js"), { mediaInfo: l, root: d } = e, { title: c } = l, h = 5, p = l?.altText || l?.title || "", m = d.container.children.push(n.new(d, { ariaLabel: p, focusable: !0, paddingBottom: h, paddingTop: h, paddingLeft: h, paddingRight: h })), f = `{category}: {valuePercentTotal.formatNumber('0.00')}%
 ({value})`, v = s.new(d, { labelText: f }), y = m.series.push(r.new(d, { name: c, valueField: ze, categoryField: he, tooltip: v }));
  ...
  async _createColumnChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-4BweAu9u.js"), { CategoryAxisAm5: l, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, ColumnSeriesAm5: p } = await import("./xyChart-DqtqSplD.js"), { mediaInfo: m, root: f } = i, { value: v, title: y } = m;
  ...
  async _createLineChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-4BweAu9u.js"), { CategoryAxisAm5: l, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, LineSeriesAm5: p } = await import("./xyChart-DqtqSplD.js"), { root: m, mediaInfo: f } = i, { value: v, title: y } = f;
    e.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e, i) {
    const { XYChartAm5: s, XYCursorAm5: n } = await import("./xyChart-DqtqSplD.js"), { root: r, mediaInfo: l } = e, { type: d } = l, c = l?.altText || l?.title || "", h = r.container.children.push(s.new(r, { ariaLabel: c, focusable: !0, panX: !0, panY: !0 }));
...
function us() {
  return import("./arcade-CNqRLsCn.js");
}
function Dr(t) {
...
let G = class extends J {
  ...
  loadDependencies() {
    return De({ icon: () => import("./calcite-icon-DlvEO2Xc.js"), list: () => import("./calcite-list-C8dyAXZG.js"), "list-item": () => import("./calcite-list-item-DIkFfrzh.js"), notice: () => import("./calcite-notice-IdXoz8LG.js") });
  }
  destroy() {
...
let D = Nt = class extends ps(J) {
  ...
  loadDependencies() {
    return De({ notice: () => import("./calcite-notice-IdXoz8LG.js") });
  }
  destroy() {
...
let we = class extends J {
  ...
  loadDependencies() {
    return De({ action: () => import("./calcite-action-DcPNhfBJ.js"), "flow-item": () => import("./calcite-flow-item-BOViyj_9.js") });
  }
  render() {
...
async function Li(t, e) {
  ...
  const { getColor: d, getOpacity: c, getAllSizes: h, getRotationAngle: p } = await import("./main-BL24Y93j.js").then((w) => w.qJ), m = [], f = [], v = [], y = [];
  ...
  constructor(t) {
    super(t), this._pendingPromises = new Jr(), this._fetchFeaturesController = null, this._highlightSelectedFeaturePromise = null, this._highlightActiveFeaturePromise = null, this._selectedClusterFeature = null, this._locationScaleHandle = null, this.actions = new Ce(), this.activeFeature = null, this.autoCloseEnabled = !1, this.autoOpenEnabled = !0, this.browseClusterEnabled = !1, this.content = null, this.defaultPopupTemplateEnabled = !1, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = !1, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = !0, this.includeDefaultActions = !0, this.selectedClusterBoundaryFeature = new Be({ symbol: new rn({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = !1, this.view = null, this.visible = !1, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = Je(async (e) => {
      ...
      if (s !== "mesh" && i && n && this.selectedFeature) if (s !== "point") try {
        ...
        if (!h) return;
        Ke || (Ke = await import("./geometryEngineAsync-Dtl-qvxu.js")), await Ke.intersects(h, n) || (this.location = (await Ke.nearestCoordinate(h, n)).coordinate ?? n);
      } catch (r) {
...
let x = class extends ps(J) {
  ...
  loadDependencies() {
    return De({ action: () => import("./calcite-action-DcPNhfBJ.js"), "action-bar": () => import("./calcite-action-bar-B494Fe3o.js"), "action-group": () => import("./calcite-action-group-BhTctY3H.js"), button: () => import("./calcite-button-Bz_ky43a.js"), flow: () => import("./calcite-flow-8icANaju.js"), "flow-item": () => import("./calcite-flow-item-BOViyj_9.js"), list: () => import("./calcite-list-C8dyAXZG.js"), "list-item": () => import("./calcite-list-item-DIkFfrzh.js"), "list-item-group": () => import("./calcite-list-item-group-vGqR8HG6.js"), loader: () => import("./calcite-loader-DLun8OLO.js") });
  }
  destroy() {
...
//# sourceMappingURL=Popup-CUxofTbU.js.map
