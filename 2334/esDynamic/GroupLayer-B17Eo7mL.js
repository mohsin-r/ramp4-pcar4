import { dV as u, dZ as c, dX as v, dY as m, gg as f, gh as g, d_ as w, bs as _, gi as I, S as L, U as y, gj as O, gk as S, a0 as V, a1 as $, gl as A, gm as d, gn as M, N as r, O as l, et as p, d$ as P, go as C, b2 as E, fi as b, P as x, e8 as T, C as j } from "./main-BL24Y93j.js";
import { a as G } from "./lazyLayerLoader-BcxVB1Mi.js";
import { r as H } from "./saveUtils-DVOSCm9k.js";
...
let s = class extends u(c(v(m(f(g(w(T))))))) {
  constructor(e) {
    super(e), this.allLayers = new _({ getCollections: () => [this.layers], getChildrenFunction: (i) => "layers" in i ? i.layers : null }), this.allTables = I(this), this.fullExtent = void 0, this.operationalLayerType = "GroupLayer", this.spatialReference = void 0, this.type = "group", this._debouncedSaveOperations = L(async (i, t, a) => {
      const { save: o, saveAs: n } = await import("./groupLayerUtils-BwhltEng.js");
      switch (i) {
        case d.SAVE:
          return o(this, t);
        case d.SAVE_AS:
...
//# sourceMappingURL=GroupLayer-B17Eo7mL.js.map
