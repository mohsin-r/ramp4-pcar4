import { af as le, hX as ue } from "./main-BL24Y93j.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-B4UsiDoq.js").then((i) => i.l) : await import("./libtess-D8HfQnjq.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-CQsny8-9.js.map
