import { N as i, O as s, P as w, dU as Y, b_ as O, bh as L, af as Fe, hX as le, s as d, eJ as ee, aT as fe, a6 as ge, aS as te, aR as re, C as _e, a2 as k, a3 as De } from "./main-BL24Y93j.js";
import { m as me, p as we, t as Ne, c as ze } from "./GraphQueryStreaming-BUlNPXR-.js";
...
async function Le(e) {
  if (e) {
    const { default: t } = await import("./arcgis-knowledge-client-core-simd-ca-PKB7B.js").then((n) => n.a);
    return t({ locateFile: (n) => le(ue + n) });
  }
  const { default: r } = await import("./arcgis-knowledge-client-core-DCQNA_Yw.js").then((t) => t.a);
...
//# sourceMappingURL=knowledgeGraphService-D7NVBv9q.js.map
