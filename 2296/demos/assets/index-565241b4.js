...
import { bG as defineComponent, bI as inject, bN as resolveComponent, bP as openBlock, bQ as createBlock, bR as withCtx, fH as createBaseVNode, iM as normalizeStyle, bS as createTextVNode, bH as useI18n, bT as toDisplayString, bU as unref, bB as FixtureInstance, he as markRaw } from './main-af5539f8.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-3ddc1d8e.js'),true?["./p2-screen-1-3ddc1d8e.js","./main-af5539f8.js","./preload-helper-a4975f27.js","./main-5c005d17.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
